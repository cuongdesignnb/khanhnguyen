...
export default function CategoryProductPage({
  ...
  const displayTitle = category ? category.name : categoryTitle
  const displaySubtitle = category ? category.subtitle : 'Chất lượng Nhật bãi – Hoạt động bền bỉ'

  return (
    <div className="bg-[color:var(--surface)] min-h-screen text-white">
      <PageHero title={displayTitle} subtitle={displaySubtitle} />
      <Breadcrumb items={[{ label: 'Sản phẩm', href: '/san-pham' }, { label: displayTitle }]} />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          ...
          <aside className="hidden lg:block lg:col-span-1">
            <div className="sticky top-28 bg-[color:var(--surface-2)] border border-white/10 rounded-xl p-5 space-y-6 max-h-[85vh] overflow-y-auto overscroll-contain scrollbar-hidden">
              ...
              <ProductFilterSidebar
                ...
                brands={brands}
                params={{ ...currentParams, category: categorySlug }} // pre-lock category input
                onChange={(p) => {
          ...
          <main className="lg:col-span-3 space-y-6">
            ...
            {category?.description && (
              <div className="bg-[color:var(--surface-2)] border border-white/10 rounded-xl p-5 sm:p-6 mt-8">
