...
export const defaultSettings = {
  ...
  homeConfig: {
    ...
    categoriesEnabled: true, categorySliderEnabled: true, categorySliderAutoplay: true,
    categorySliderIntervalMs: 3500, categorySliderPauseOnHover: true,
    categorySliderShowArrows: true, categorySliderLoop: true,
    categorySliderDesktopItems: 8, categorySliderLaptopItems: 6,
    categorySliderTabletItems: 4, categorySliderMobileItems: 2,
    categorySliderMaxItems: 20, brandsEnabled: true,
    brandSectionEyebrow: 'THƯƠNG HIỆU', brandSectionTitle: 'THƯƠNG HIỆU NỔI BẬT',
    brandSliderEnabled: true, brandSliderAutoplay: true, brandSliderIntervalMs: 3000,
    brandSliderPauseOnHover: true, brandSliderShowArrows: true, brandSliderLoop: true,
    brandSliderDesktopItems: 6, brandSliderTabletItems: 4, brandSliderMobileItems: 2, brandSliderMaxItems: 20,
    servicesEnabled: true, testimonialsEnabled: true, statsEnabled: true,
