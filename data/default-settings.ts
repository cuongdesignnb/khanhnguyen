...
export const defaultSettings = {
  ...
  homeConfig: {
    ...
    videoSectionEnabled: true, videoSectionEyebrow: 'VIDEO THỰC TẾ', videoSectionTitle: 'VIDEO XE NÂNG KHANH NGUYÊN',
  ...
  productDetailConfig: {
    ...
    pageDescription: '',
    emptyMessage: '',
    warrantySectionEnabled: true,
    warrantySectionTitle: 'CHÍNH SÁCH BẢO HÀNH & HỖ TRỢ',
    warrantyPrimaryTitle: 'Bảo hành 6 – 12 tháng',
    warrantyPrimaryDescription: 'Bảo hành từ 6 đến 12 tháng hoặc 1000 giờ hoạt động tùy điều kiện nào đến trước. Hỗ trợ kỹ thuật 24/7 qua hotline, Zalo.',
    technicalSupportTitle: 'Hỗ trợ kỹ thuật 24/7',
    technicalSupportDescription: 'Đội ngũ kỹ thuật chuyên nghiệp, giàu kinh nghiệm luôn sẵn sàng giải quyết mọi vấn đề phát sinh. Hỗ trợ khắc phục sự cố tận nơi trong thời gian ngắn nhất.',
    genuinePartsTitle: 'Cung cấp phụ tùng chính hãng',
    genuinePartsDescription: 'Kho phụ tùng dồi dào, đầy đủ linh kiện thay thế cho các hãng Toyota, Komatsu, Mitsubishi, TCM... Bảo trì định kỳ miễn phí trong thời gian bảo hành.',
    lifetimeSupportTitle: 'Hỗ trợ kiểm tra, bảo trì trọn đời',
    lifetimeSupportDescription: 'Sau thời gian bảo hành, Khanh Nguyên vẫn hỗ trợ kiểm tra xe nâng định kỳ và sửa chữa với chi phí ưu đãi nhất cho quý khách hàng.',
  },
