...
assert.equal(normalizeOpenAIOutputTokens(0), 1)
assert.equal(normalizeOpenAIOutputTokens(1), 1)
...
assert.equal(normalizeOpenAIOutputTokens(-10), 1)
assert.equal(normalizeOpenAIOutputTokens(1000.9), 1000)
assert.equal(normalizeOpenAIOutputTokens(200_000), 128_000)
